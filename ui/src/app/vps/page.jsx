...
export default function VMDashboard() {
  ...
  const fetchVM = async () => {
    try {
      setError(null)
      const res = await fetch("https://remixorbit.in/vpsserver/api/vm-status", { credentials: "include" })
  ...
  const fetchUsage = async () => {
    try {
      const res = await fetch("https://remixorbit.in/vpsserver/api/stats/container-usage", {
        method: "GET",
  ...
  const performAction = async (action) => {
    ...
    setSuccessMessage("")
    try {
      const res = await fetch("https://remixorbit.in/vpsserver/api/vm-action", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const createVM = async () => {
    ...
    setSuccessMessage("")
    try {
      const res = await fetch("https://remixorbit.in/vpsserver/api/create-vm", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({
  ...
  const updatePassword = async () => {
    ...
    setSuccessMessage("")
    try {
      const res = await fetch("https://remixorbit.in/vpsserver/api/fix-vm-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
